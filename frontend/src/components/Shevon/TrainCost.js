  ...
  return (
    <div>
      <div class="grid grid-cols-2 ">
        <div
          class="rounded-xl   mt-2 mx-0 px-0 py-0  border-0  shadow-md bg-lightSilver bg-opacity-20 overflow-y-auto "
          style={{ height: "490px" }}
        >
          ...
          <div class="rounded-xl   my-2 mx-2 px-5 py-5  border-0  shadow-md bg-prussianBlue bg-opacity-20  ">
            ...
            >
              <div>
                <h5 class="text-black font-black">
                  <icons class="text-gray-500 mr-5 ">
          ...
          {railWays.map((railWay) => (
            <div class="rounded-xl   my-2 mx-2 px-5 py-5  border-0  shadow-md bg-blueSapphire ">
              <div class="grid grid-cols-2">
                <div>
                  <h5 class="text-white font-extrabold">
                    {railWay.destination}
                  </h5>
                </div>
        ...
        <div
          class="rounded-xl   mt-2 ml-2 px-0 py-0  border-0  shadow-md bg-white bg-cover bg-center "
          style={{
