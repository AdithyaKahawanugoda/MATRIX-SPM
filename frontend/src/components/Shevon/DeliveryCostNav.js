...
<Grid item xs={12}>
        <Paper class=" rounded-xl px-3 py-3 text-center border-0  shadow-md bg-blueSapphire bg-opacity-30">
          {retailDeliveryCostOpen && < header class="font-contentFont text-4xl mb-3 font-bold text-prussianBlue ">
            Retail Delivery Cost Managment
          </header>}

          {bulkDeliveryCostOpen && < header class="font-contentFont text-4xl mb-3 font-bold text-prussianBlue ">
            Bulk Delivery Cost Managment
          </header>}

          {trainCostOpen && < header class="font-contentFont text-4xl mb-3 font-bold text-prussianBlue ">
          ...
          <div>
            ...
            <div>
              <button class= " mt-5  mb-2 bg-blueSapphire hover:bg-prussianBlue text-white font-bold py-2 px-8 rounded-full"
               onClick={() => {
