...
const AddCategoryModal = ({ setModalVisible, modalVisible }) => {
  return (
    ...
    >
      ...
      <h6 className="ml-4 mt-0 mb-1 font-black text-2xl text-center">Add New Category</h6>
      <hr></hr>
          ...
          {({ handleChange, handleSubmit, values, errors, touched }) => (
            ...
            >
              ...
              <div class="flex ">
                      ...
                      <div class="flex-initial" style={{ marginLeft: "10px" }}>
                        <input
