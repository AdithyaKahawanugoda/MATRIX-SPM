...
function createData(no, code, name, address, deliveryType, action) {
  return {
    no,
    code,
    name,
...
const rows = [
  createData(1, "000001", "SARASAVI", "20,380", "PENDING", <EditIcon />),
  createData(2, "000002", "SOORIYA", "3,177", "COMPLETE", <EditIcon />),
  createData(1, "000003", "GUNASENA", "15,000", "COMPLETE", <EditIcon />),
  createData(1, "000004", "SARASAVI", "22,380", "PENDING", <EditIcon />),
  createData(1, "000005", "SAMUDRA", "12,380", "COMPLETE", <EditIcon />),
];
