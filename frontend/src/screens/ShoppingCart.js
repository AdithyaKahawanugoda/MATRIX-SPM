...
const ShoppingCart = (props) => {
  ...
  const qutIncrease = (pID, unitPrice,bookName,weight) => {
    ...
    finalOrder.push({ productID: pID, quantity: tempQut + 1 ,bookName:bookName,weight:weight});
              ...
              <Image cloudName="grid1234" publicId={item.proImg}/>
               ...
               <div className="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
                 <div className="mb-8">
                   ...
                   <h5 className="text-gray-700 text-base mb-2">{item.unitPrice}</h5>
                   ...
                   <div className="flex flex-row">
                     ...
                     onClick={()=>{
                       qutDecrease(item.productID,item.unitPrice,item.originalTitle,item.weight);
                     }}
                     >
                       -
                     </Button>
                     ...
                     <div className="m-1">
                       ...
                       <Button variant="contained" color="primary"
                       onClick={()=>{
                         qutIncrease(item.productID,item.unitPrice,item.originalTitle,item.weight);
                       }}>
                         +
                       </Button>
                     </div>
